...
public class DuplicateFileFinder {
    ...
    public static void main(String[] args) {
		...
		/*
		 * if (args.length < 1) { System.out.println("Please supply a directory path");
		 * return; }
		 */
        ...
        DuplicateFileFinder.findDuplicateFiles(lists, dir);
    ...
    public static void findDuplicateFiles(Map<String, List<String>> filesList, File directory) {
    	System.out.println("Processing Dir: " + directory.getAbsolutePath());
